/*
  Bewerk hier zelf alle teksten van de opdrachten.

  Indeling:
  - taal > groep-3-4 / groep-5-6 / groep-7-8 > tijdens / bewegend
  - spelling > groep-3-4 / groep-5-6 / groep-7-8 > tijdens / bewegend
  - rekenen > groep-3-4 / groep-5-6 / groep-7-8 > tijdens / bewegend
  - energizers > activerend / focussend / kalmerendActief

  Per opdracht kun je aanpassen:
  - title
  - summary
  - duration
  - setup
  ...
  Voorbeeld: taal > groep-5-6 > tijdens > vraag-en-antwoordwandeling
*/

window.taskTextOverrides = {
  taal: {
    "groep-3-4": {
      tijdens: {
      ...
      bewegend: {
        ...
        "verhaalpad-drie-stappen": {
          ...
          materials: [
            "Drie kaartjes of vellen papier"
          ],
          steps: [
    ...
    "groep-7-8": {
      ...
      bewegend: {
        ...
        "tekstsoorten-hoeken": {
          ...
          materials: [
            "Tekstkaartjes of korte fragmenten"
          ],
          steps: [
    ...
    "groep-3-4": {
      ...
      bewegend: {
        ...
        "korte-klank-lange-stap": {
          ...
          materials: [
            "Eventueel twee kaartjes met de labels"
          ],
          steps: [
        ...
        "woord-bouwen-met-lichaamsletters": {
    ...
    "groep-3-4": {
      tijdens: {
        "rekenbevries": {
          ...
          materials: [
            "Geen extra materiaal",
            "Eventueel vingers of antwoordkaartjes"
          ],
          steps: [
      ...
      bewegend: {
        ...
        "tafels-springen": {
          ...
          materials: [
            "Geen extra materiaal of vloergetallenlijn"
          ],
          steps: [
    ...
    "groep-7-8": {
      tijdens: {
        ...
        "keuzehoeken-rekenen": {
          ...
          materials: [
            "Hoekkaartjes of geprinte antwoorden"
          ],
          steps: [
            "Geef een vraag met 4 antwoordmogelijkheden.",
      ...
      bewegend: {
        ...
        "schaalwandeling": {
          ...
          materials: [
            "Meetlint of vooraf gemeten afstand"
          ],
          steps: [
  ...
  energizers: {
    activerend: {
      ...
      "bewegingen-estafette-op-de-plek": {
      ...
      "springparcours-zonder-materiaal": {
      ...
      "tel-samen-naar-20-met-beweging": {
    ...
    focussend: {
      ...
      "hoofd-schouders-knieen-tenen-plus": {
